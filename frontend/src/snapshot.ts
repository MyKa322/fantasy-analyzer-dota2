...
export interface PlayoffMatch {
  ...
  /**
   * Кого сюда приводит разводка по фаворитам — по одному прогнозу на сторону,
   * в том же порядке, что left и right. `chance` — вероятность прийти сюда
   * именно этой веткой, а не дойти до места любой дорогой.
   */
  projected?: { team_id: number; chance: number }[];
}
